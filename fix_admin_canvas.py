...
if old_canvas_logic in content:
    with open('src/views/AdminView.tsx', 'w') as f:
        f.write(content.replace(old_canvas_logic, new_canvas_logic))
    print("Canvas logic updated successfully")
else:
    print("Could not find canvas logic")
